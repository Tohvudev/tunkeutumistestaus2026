...
## x) Tiivistelmä [Conducting a penetration test with Metasploit](https://learning.oreilly.com/library/view/mastering-metasploit/9781838980078/B15076_01_Final_ASB_ePub.xhtml#_idParaDest-31)

- Avoimen lähdekoodin ohjelma
- Käyttää tietokantaa löydettyjen asioiden tallentamiseen
- Nmap skannaukset esim. tallentuu tietokantaan (yhdistää skannauksen ja tiedonkeruun)
- Löydetty haavoittuvuus ja sen hyväksikäyttö suoritetaan skriptillä ja ajetaan hyökkäys
- Hyökkääjä voi siirtyä huomaamattomampiin prosesseihin ja rakentaa itselleen tietä syvemmälle sisäverkkoon
- Työkalut hankkivat ylläpitäjän oikeudet ja kaivaa salasanoja muistista hyökkäyksen helpottamiseksi

##### Mitä nmap -sn tekee?

Nmap skannaa verkkoa ja katsoo mitkä laitteet ovat verkossa aktiivisina, mutta ei tee porttiskannausta. Se tarkastaa vain onko kone aktiivisena verkossa. Tämä mahdollistaa tiedon keräämisen laitteista herättämättä liikaa huomiota. [[Lähde]](https://nmap.org/book/man-host-discovery.html)

Käytetty lähde Nmap.org on arvioitu luotettavaksi ensisijaislähteeksi, se on ohjelmiston virallinen kehityspaikka ja dokumentaatio perustuu avoimeen lähdekoodiin sekä ammattilaisten vertausarviontiin. Parempaa lähdettä ei varmaankaan ole. Vaikka absoluuttista takuuta minkään verkosta löytyvän tiedon oikeellisuudesta on mahdotonta antaa, pidän Nmap.org sivustoa luotettavana lähteenä yllä mainittujen asioiden takia.
...
## e) (-oA foo) vs db_nmap:n tallennus tietokantoihin
...
## j) Shelli talteen tekstitiedostoon
...
Metasploitable 2 Exploitability Guide – https://docs.rapid7.com/metasploit/metasploitable-2/

Samba "username map script" Command Execution (CVE-2007-2447) – https://www.rapid7.com/db/modules/exploit/multi/samba/usermap_script/
...
The vsftpd Project - Official Documentation – https://security.appspot.com/vsftpd.html
